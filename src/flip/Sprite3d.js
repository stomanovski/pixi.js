...
{
    if(this.parent.convertFrom2dTo3d && this.parent.parent)
    {
...
Sprite3d.prototype.updateTransform3d = function()
{
    ...
    if(this.postTransform3DCallback) {
        this.postTransform3DCallback(this);
        this.postTransform3DCallback = null;        
    }
};
...
Sprite3d.prototype.getBounds = function () {
